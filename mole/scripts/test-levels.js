...
// pos=(70/140)*9=4.5 → i=4,frac=0.5 → keyframes[4]=keyframes[5]=0.08 (인접 키프레임이 같은 값이라 그대로 0.08)
assert.ok(Math.abs(L.interpolate(L.BOMB_CHANCE_BY_ROUND, 70, 140) - 0.08) < 1e-9);
