(function (root) {
  ...
  var BLOCKS_KO = [
    { title: '두더지 게임의 역사' },
    { img: 'assets/intro/1.png', cap: '1975 · 일본 「もぐら退治」' },
    ...
    { img: 'assets/intro/2.png', cap: '1979 · 미국 「Whac-A-Mole」' },
    { p: '미국에서는 Whac-A-Mole 이라는 이름으로 알려지면서 놀이공원과 오락시설의 대표적인 반응형 게임으로 자리 잡았습니다.' },
    { img: 'assets/intro/3.png', cap: '2000년대 · 대한민국 오락실' },
    { p: '그리고 50년이 지난 지금.' },
  ...
  var BLOCKS_EN = [
    ...
    { img: 'assets/intro/1.png', cap: '1975 · Japan “Mogura Taiji”' },
    ...
    { img: 'assets/intro/2.png', cap: '1979 · USA “Whac-A-Mole”' },
    ...
    { img: 'assets/intro/3.png', cap: '2000s · Arcades in Korea' },
