(function (root) {
  ...
  const POSES = [
    ...
    { key: 'a5', src: 'assets/weapons/cannon-a5.png', w: 0.225, ar: 1.256, mu: 0.17, mv: 0.09, aim: -120, tweak: 0, dx: -0.009, dy: -0.03, blx: -0.002, bly: -0.015 },
  ...
  const FX_NUDGE = {
    ...
    a3: { spark: { dx: -0.029 }, flame: { rot: 22, dx: -0.043, dy: -0.021 }, smoke: { rot: 10, dx: -0.043, dy: 0.014 } },  // 대기포 1·2·5·9
