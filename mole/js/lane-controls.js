(function (root) {
  ...
  const SVG = {
    ...
    locker: '<svg viewBox="0 0 24 24" fill="currentColor" fill-rule="evenodd" stroke="none"><path d="M 20.75,22.71 L 18.43,22.71 L 17.87,22.52 L 12.33,17.13 L 10.79,18.62 L 10.70,19.66 L 10.08,21.03 L 9.21,21.96 L 8.40,22.43 L 7.36,22.71 L 4.62,22.71 L 3.20,22.19 L 2.14,21.27 L 1.52,20.28 L 1.29,19.38 L 1.33,16.26 L 2.04,14.74 L 2.73,14.06 L 3.75,13.47 L 2.44,13.06 L 0.86,11.43 L 0.58,10.53 L 0.58,8.64 L 0.72,8.03 L 1.14,7.41 L 2.68,5.87 L 3.23,5.85 L 3.23,4.86 L 3.46,4.20 L 4.86,2.80 L 5.42,2.56 L 6.13,2.56 L 7.36,1.71 L 9.63,0.81 L 11.05,0.58 L 14.79,0.58 L 14.84,2.00 L 15.60,1.52 L 16.64,1.24 L 19.28,1.24 L 20.70,1.71 L 22.00,2.87 L 22.48,3.72 L 22.76,4.95 L 22.76,7.03 L 22.48,8.31 L 21.96,9.21 L 21.18,9.99 L 19.76,10.65 L 18.67,10.79 L 17.79,11.62 L 23.05,16.92 L 23.38,17.63 L 23.42,19.85 L 23.19,20.66 L 21.74,22.19 L 20.75,22.71 Z M 6.11,21.13 L 7.18,20.77 L 8.19,19.99 L 9.04,18.62 L 9.28,17.11 L 11.57,14.86 L 13.18,14.86 L 19.57,21.06 L 20.23,20.68 L 21.58,19.28 L 21.77,18.95 L 21.53,18.53 L 15.48,12.47 L 15.48,10.91 L 17.16,9.28 L 18.24,9.14 L 19.66,8.48 L 20.44,7.70 L 20.96,6.80 L 21.15,6.18 L 20.96,5.33 L 20.49,4.48 L 19.62,3.60 L 18.01,2.89 L 17.20,3.13 L 16.35,3.65 L 15.29,4.90 L 14.91,5.90 L 14.81,6.94 L 12.85,8.90 L 11.24,8.90 L 10.98,8.64 L 10.89,7.74 L 9.94,6.84 L 9.94,5.24 L 10.04,4.76 L 10.53,4.17 L 12.43,3.60 L 13.02,2.97 L 13.23,2.18 L 11.24,2.42 L 9.73,2.94 L 7.74,4.17 L 7.03,4.17 L 6.47,4.41 L 5.07,5.80 L 4.93,7.46 L 4.29,7.48 L 2.75,9.02 L 2.33,9.63 L 2.56,10.06 L 4.48,11.79 L 6.56,9.90 L 8.17,9.90 L 8.40,10.18 L 9.16,10.18 L 9.61,10.58 L 9.61,12.14 L 6.99,14.77 L 5.38,15.05 L 4.34,15.67 L 3.65,16.35 L 2.99,17.68 L 3.13,18.76 L 3.75,19.76 L 4.81,20.68 L 6.11,21.13 Z M 12.45,6.09 L 13.04,5.45 L 11.98,5.76 L 12.45,6.09 Z"/></svg>',
  ...
  function create({ buttonBar, gridSize, onCell, onTap, onHomeAction, isHome, simple }) {
    ...
    function setFeverScoreboard(comboVal, secondsLeft) {
      ...
      var t = document.getElementById('fever-sb-time');
