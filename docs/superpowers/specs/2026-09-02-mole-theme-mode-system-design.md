...
> **⚠️ 폐기(SUPERSEDED) 2026-09-03.** 이 문서는 `2026-09-03-mole-standalone-app-design.md`로 대체됨.
> 홈화면·난이도 방향이 바뀌었고(카톡 더보기 다크 / 하수·고수·전설), 핵심 콘텐츠가 사람두더지 메이커로 정해짐.
> 이 문서의 모드 캐러셀(폭탄/다때려/안경만/두더지빼고)은 새 스펙의 **Phase 3**로 이월 — 데이터 설계는 참고용으로 유효.
